...
const SAMPLE_PRODUCTS = [
  ...
  {
    id: "3",
    autoIncrementId: 1003,
    name: "Mekanik Klavye Türkçe Q Blue Switch RGB Aydınlatmalı Gaming Oyuncu Klavyesi",
    sku: "MKT-003",
    barcode: "8690123456791",
    stock: 0,
    costPrice: 450,
    costPriceWithShipping: 485,
    basePrice: 899,
    discountedPrice: null,
    brand: "GameTech",
    category: "Bilgisayar > Klavye",
    supplier: "Mapaş",
    isActive: false,
    isDraft: false,
    showInCategory: true,
    ...
    showInBrandPage: true,
    isTagFeatured: false,
    featuredImage: "https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=400&h=400&fit=crop"
  },
  {
    id: "2",
...
export default function ProductsPage() {
  ...
  const filteredProducts = products
    .filter(product => {
      ...
      // Envanter durumu filtresi
      if (inventoryStatusFilter === 'active' && !product.isActive) {
        return false
      }
      if (inventoryStatusFilter === 'inactive' && product.isActive) {
        return false
      }
      ...
      <div className="p-8 space-y-6 bg-gray-50/50 dark:bg-gray-900">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Select value={inventoryStatusFilter} onValueChange={setInventoryStatusFilter}>
            <SelectTrigger className="w-[160px] h-9 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-xs">
              <SelectValue placeholder="Envanter Durumu" />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="all">Envanter Durumu</SelectItem>
          ...
          {(inventoryStatusFilter !== 'all' || supplierFilter !== 'all' || stockStatusFilter !== 'all' ||
        ...
        {(inventoryStatusFilter !== 'all' || supplierFilter !== 'all' || stockStatusFilter !== 'all' ||
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            {inventoryStatusFilter !== 'all' && (
              <Badge variant="secondary" className="text-xs px-2 py-0.5 bg-blue-50 text-blue-700 dark:bg-blue-950 dark:text-blue-300">
                Envanter: {inventoryStatusFilter === 'active' ? 'Aktif' : 'Pasif'}
              </Badge>
            )}
            {supplierFilter !== 'all' && (
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell className="py-2 h-12">
                          {product.isDraft ? (
                            <Badge variant="outline" className="text-[10px] px-2 py-0.5 h-5 bg-yellow-50 dark:bg-yellow-900/20 text-yellow-700 dark:text-yellow-400 border-yellow-300 dark:border-yellow-700">
                              Taslak
                            </Badge>
                          ) : product.isActive ? (
                        ...
                        <TableCell className="py-2 h-12 text-center">
                          <div className="flex items-center justify-center gap-1">
                            ...
                            <Button
                              ...
                              onClick={() => !product.isDraft && handleToggleActive(product.id, product.isActive)}
