          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-blue-100 leading-relaxed">
                Hesap oluşturun ve e-ticaret operasyonlarınızı otomatikleştirmeye başlayın.
                Modern arayüz ve gelişmiş özelliklerle işlerinizi kolaylaştırın.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-blue-100">Ücretsiz deneme sürümü</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                <span className="text-blue-100">Kredi kartı gerektirmez</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                <span className="text-blue-100">Anında başlayın</span>
              </div>
            </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-200">Tüm özelliklere erişim</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-10 text-sm border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-10 text-sm border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-lg"
                    required
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-start space-x-2 pt-2">
                ...
                <Label htmlFor="terms" className="text-xs text-gray-600 cursor-pointer leading-relaxed">
                  <Link href="#" className="text-indigo-600 hover:text-indigo-500">Kullanım koşullarını</Link> ve{" "}
                  <Link href="#" className="text-indigo-600 hover:text-indigo-500">gizlilik politikasını</Link> kabul ediyorum
                </Label>
              </div>
              ...
              <Button
                type="submit"
                className="w-full h-10 mt-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-200"
              >
